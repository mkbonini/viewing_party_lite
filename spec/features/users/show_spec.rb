...
RSpec.describe 'user dashboard(show)' do
  it "can render a particular user's show page" do
    user_1 = User.create!(name: 'Nick', email: 'testemail1@mail.com', password: '123test')
    user_2 = User.create!(name: 'Mike', email: 'testemail2@mail.com', password: '123test')
  ...
  it "shows a user's view parties along with a status" do
    user_1 = User.create!(name: 'Nick', email: 'testemail1@mail.com', password: '123test')
    user_2 = User.create!(name: 'Mike', email: 'testemail2@mail.com', password: '123test')
    user_3 = User.create!(name: 'Bob', email: 'testemail3@mail.com', password: '123test')
  ...
  it 'has a link to Discover Movies' do
    user_1 = User.create!(name: 'Bob', email: 'testemail1@mail.com', password: '123test')
